...
class TradeTable(QMainWindow):
    def __init__(self):
        ...
        self.hscode_edit.textChanged.connect(self.update_item_name) 
        ...
        self.top_layout.addWidget(self.item_name_label)  
    ...
    def show_graph(self):
        ...
        # 설정
        self.figure_export = plt.Figure(figsize=(8, 4))
        self.figure_import = plt.Figure(figsize=(8, 4)) 
        ...
        self.ax_export.set_title('수출 단가', fontsize=12)  
        self.ax_export.set_xlabel('국가', fontsize=10)  
        self.ax_export.set_ylabel('단가($/kg)', fontsize=10)  
        self.ax_export.tick_params(axis='x', rotation=90, labelsize=8)  
        self.ax_export.tick_params(axis='y', labelsize=8)  

        # 수입 
        self.ax_import.bar(sorted_import_data['국가'], sorted_import_value_per_weight, color='green')
        self.ax_import.set_title('수입 단가', fontsize=12)  
        self.ax_import.set_xlabel('국가', fontsize=10)  
        self.ax_import.set_ylabel('단가($/kg)', fontsize=10)  
        self.ax_import.tick_params(axis='x', rotation=90, labelsize=8)  
        self.ax_import.tick_params(axis='y', labelsize=8)  
